...
const variantStyles = {
  ...
  outline: {
    slate:
      'ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-400 active:bg-slate-100 active:text-slate-700 focus-visible:outline-blue-600 focus-visible:ring-slate-400',
    white:
